...
def predict(input_object, model):
    ...
    logger.info(
        "--- Inference time: %s seconds ---" % (time.time() - start_time))
...
def input_fn(request_body):
    ...
    # Modified the function according to our need
    write_to_file("/tmp/photo.jpg", request_body)
    img = PIL.Image.open("/tmp/photo.jpg")
