...
let arr2;
(function() {
    // arr2 = arr1; // this will assign arr1 to arr2 means if you change arr1
    // it will automatically change arr2

    arr2 = [...arr1]; // this is known as spreading, it individually copies all
    // elements of arr1 to arr2. So, if we change arr1 then also arr2 will not
    // change
    arr1[0] = "potato";
})();
console.log(arr2);

// ####################### Use destructing assignment to assign variables from
// objects
